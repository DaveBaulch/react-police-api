    ...
    return (
      <div className="App">
        <Router history={createBrowserHistory}>
          ...
          import './App.css'; import React from 'react'; import axios from
          'axios'; import {(Router, Route, Switch)} from 'react-router-dom';
          import Dropdown from './components/Dropdown'; import Searches from
          './components/Searches'; import SearchesItemDetail from
          './components/SearchesItemDetail'; import MapContainer from
          './components/MapContainer'; import FormSelect from
          './components/FormSelect'; import Header from './components/Header';
          import Index from './pages/Index'; import Page1 from './pages/Page1';
          import createBrowserHistory from './history'
        </Router>
      </div>
    );
