  ...
  render() {
    return (
      <div className="App">
        ...
        {this.state.selectedForceDescription && (
          <h2>
            Selected force decription:
          </h2>
          <div dangerouslySetInnerHTML=dangerouslySetInnerHTML={this.state.selectedForceDescription}></div>
    )
  }
