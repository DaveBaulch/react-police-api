        ...
        {this.state.selectedSearchData && (
          <React.Fragment>
            ...
            <select id="offenceFilter" onChange={this.onOffenceChange}>
              ...
              <option value="Offensive weaponss">Offensive weaponss</option>
              <option value="Stolen goods">Article for use in theft</option>
              Offensive weapons Article for use in theft
            </select>
          </React.Fragment>
        )}
