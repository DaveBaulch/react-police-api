...
class LocationPage extends React.Component {
  ...
  filteredResults(query) {
    return this.state.selectedSearchData.filter((search, query) => {
      return (
        search.gender === query &&
  ...
  getOffenceData = () => {
    // let maleSearches = this.state.selectedSearchData.filter((search) => {
    //   return (
    //     search.gender === 'Male' &&
    //     search.object_of_search === this.state.filterTerms.offenceFilterTerm
    //   );
    ...
    // let femaleSearches = this.state.selectedSearchData.filter((search) => {
    //   return (
    ...
    // });
      ...
      let searches = this.state.selectedSearchData.filter((search, gender) => {
        return (
      ...
      retturn result = addressBook.filter(startsWith("word"));
    }

    return [
      this.filteredResults('Male').length,
      this.filteredResults('Female').length
    ];
  };
