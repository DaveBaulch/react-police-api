...
class LocationPage extends React.Component {
  ...
  getSearches = () => {
    ...
    policeapi
      ...
      .then((response) => {
        ...
        let maleSearches = selectedSearchData.filter(function (entry) {
          return entry.gender === 'Male';
        });

        let femaleSearches = selectedSearchData.filter(function (entry) {
          return entry.gender === 'Feale';
        });        
  ...
  //     const maleEntries = this.state.selectedSearchData.filter(function (
  //       entry
  //     ) {
  //       return entry.gender === 'Male';
  //     });
  //     console.log('male: ' + maleEntries.length);
  //     return maleEntries.length;
  //   }
  // };

  // getFemale = () => {
  //   if (this.state.searchDataLoaded) {
  //     const femaleEntries = this.state.selectedSearchData.filter(function (
  //       entry
  //     ) {
  //       return entry.gender === 'Female';
  //     });
  //     console.log('female: ' + femaleEntries.length);
  //     return femaleEntries.length;
  //   }
  // };
