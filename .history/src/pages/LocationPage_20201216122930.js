...
class LocationPage extends React.Component {
  ...
  getOffenceData = () => {
    let maleSearches = this.state.selectedSearchData.filter(function (search) {
      return (search.gender === 'Male' && item.object_of_search === this.state.filterTerms.offenceFilterTerm)
    });
    let femaleSearches = this.state.selectedSearchData.filter(function (
      search
    ) {
      return search.gender === 'Female' && item.object_of_search === this.state.filterTerms.offenceFilterTerm;
    });
    console.log(maleSearches.length + ',' + femaleSearches.length);
